...
export default function Page() {
  ...
  const connCmd = `curl -sL https://raw.githubusercontent.com/octocl/pylaunch/main/admin/public/setup-agent.sh | bash -s -- https://your-server.com || wget -qO- https://raw.githubusercontent.com/octocl/pylaunch/main/admin/public/setup-agent.sh | bash -s -- https://your-server.com`;
